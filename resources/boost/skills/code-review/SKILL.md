...
When asked to review a diff, pending changes, or a PR branch against the
Scrapkit engineering standards — before merging, or when finishing a task.
...
2. Evaluate in this order: correctness, security, tests, performance,
   ...
   Use `references/pull-request-guidelines.md` and
   `references/security-guidelines.md` as the checklist.
